...
export const elements = {
  ...
  syncWorldCupForm: document.querySelector("#syncWorldCupForm"),
  worldCupApiKey: document.querySelector("#worldCupApiKey"),
  syncWorldCupNote: document.querySelector("#syncWorldCupNote"),
